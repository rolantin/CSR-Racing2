...
uniform     mediump float _kLiveryZoneToggleArr[16];
...
void main()
{
    ...
    vs_TEXCOORD2.y = _kLiveryZoneToggleArr[u_xlati0];
    vs_TEXCOORD3.xy = in_TEXCOORD0.xy * vec2(_kLiveryUVScale);
    vs_TEXCOORD2.x = in_COLOR0.x;
    return;
}