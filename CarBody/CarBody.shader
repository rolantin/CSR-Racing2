Shader "Unlit/CarBody"
{
    ...
    u_xlat21 = dot(NomalDir.xyz, NomalDir.xyz);
    u_xlat21 = rsqrt(u_xlat21);
    u_xlat1.xyz = (u_xlat21) * NomalDir.xyz;
    u_xlat21 = dot((-u_xlat0.xyz), u_xlat1.xyz);
    u_xlat21 = u_xlat21 + u_xlat21;
    u_xlat2.xyz = u_xlat1.xyz * (-(u_xlat21)) + (-u_xlat0.xyz);
...
#endif
    u_xlat10_7.xyz = texCUBE(_DiffAmbientMap, u_xlat1.xyz).xyz;
    u_xlat10_1 = texCUBE(_DiffAmbientMap, u_xlat2.xyz).w;
    ...
    u_xlat4.yz = (u_xlat23) * u_xlat13.xy;
    ...
    u_xlat4.xyz = (u_xlat22) * u_xlat6.xyz;
    u_xlat4.xyz = u_xlat4.xyz * (_kMetallicBoost);
    ...
    u_xlat4.xyz = (u_xlat22) * u_xlat10_5.xyz;
    ...
    u_xlat10_2 = texCUBElod(_SpecAmbientMap, float4(u_xlat2.xyz, u_xlat8));
    ...
    u_xlat21 = VertexColor.x * _gkVehicleExposure;
    float4 SV_Target0;
    SV_Target0.xyz = (u_xlat21) * u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return SV_Target0;
